...
public final class Album {
     ...
     * Preview picture.
     */
    public static BasicGalleryWrapper<GalleryWrapper, String, AlbumFile,String, String> gallery(Activity activity) {
     ...
     * Preview Album.
     */
    public static BasicGalleryWrapper<GalleryAlbumWrapper, AlbumFile, AlbumFile,String, AlbumFile> galleryAlbum(Activity activity) {
     ...
     * Preview picture.
     */
    public static BasicGalleryWrapper<GalleryWrapper, String,AlbumFile, String, String> gallery(Fragment fragment) {
     ...
     * Preview Album.
     */
    public static BasicGalleryWrapper<GalleryAlbumWrapper, AlbumFile, AlbumFile,String, AlbumFile> galleryAlbum(Fragment fragment) {
     ...
     * Preview picture.
     */
    public static BasicGalleryWrapper<GalleryWrapper, String, AlbumFile,String, String> gallery(android.support.v4.app.Fragment fragment) {
     ...
     * Preview Album.
     */
    public static BasicGalleryWrapper<GalleryAlbumWrapper, AlbumFile,AlbumFile, String, AlbumFile> galleryAlbum(android.support.v4.app.Fragment fragment) {
